...
@cocotb.test()
async def test_twelvebitreg(dut):
    """Test the twelveteen-bit register."""
    ...
    load_value = 0b1110_0000_1111  # Random 16-bit value
    ...
    dut._log.info("twelveteenbitreg test passed!")